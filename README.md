...
* **`Configurations/`**: Contains global configuration files used across all scripts.
...
* **`Prompt/`**: Markdown files containing the exact prompts submitted to the Gemini API for metadata extraction.
...
* **`Analysis/`**: Contains the core statistical analyses.
* **`Figures/`**: Scripts dedicated to generating the figures presented in the manuscript.
* **`Others/`**: Miscellaneous helper scripts.

### Large Language Model (LLM) Configuration
The metadata extraction from full-text PDFs was performed using the **Gemini 2.5 Flash** via Gemini API. To ensure reproducibility and transparency, the model was configured and accessed with the following specifications:
